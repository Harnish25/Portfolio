  ...
  return (
    <div id="main-content" className="relative min-h-screen overflow-x-hidden bg-black text-white">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-20 flex h-full items-center pt-20">
          <div className="mx-auto max-w-7xl w-full px-6">
            ...
            >
              <div className="flex flex-col justify-center gap-8">
                ...
                <motion.p variants={itemVariants} className="max-w-lg text-lg leading-8 text-white/65">
                  {profile.intro}
                </motion.p>
              ...
              <motion.div variants={containerVariants} className="grid grid-cols-2 gap-6">
                {metrics.map((metric, index) => (
                  <motion.div
                    ...
                    className="group rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl transition-all duration-300 hover:border-cyan-400/30 hover:bg-white/10"
                  >
                    <p className="text-4xl font-bold text-cyan-300 drop-shadow-[0_0_16px_rgba(0,217,255,0.6)]">{metric.value}</p>
        ...
        <motion.div
          className="absolute bottom-8 left-1/2 z-20 -translate-x-1/2 flex flex-col items-center gap-2 text-white/35 pointer-events-none"
      ...
      {/* ── Tech Stack Ticker ──────────────────────────────────── */}
      <AnimatedSection className="relative border-y border-cyan-400/[0.12] py-10 bg-[rgba(0,217,255,0.02)]">
      ...
      {/* ── Featured Projects ──────────────────────────────────── */}
      <AnimatedSection id="projects" className="relative py-28">
        <div className="mx-auto max-w-7xl px-6">
          <motion.div
      ...
      {/* ── Process ────────────────────────────────────────────── */}
      <AnimatedSection id="process" className="relative py-28">
        {/* Top divider glow */}
                ...
                return (
                  <ParallaxSection key={index} speed={index % 2 === 0 ? -0.6 : 0.6}>
                    <motion.div
                      ...
                      className="group relative overflow-hidden rounded-2xl border border-white/[0.08] bg-gradient-to-br from-white/[0.04] to-white/[0.01] p-8 backdrop-blur-xl transition-all duration-500 h-full"
                    >
              ...
              {testimonials.map((testimonial, index) => (
                <ParallaxSection key={index} speed={0.4 + index * 0.2} opacity={true}>
                  <motion.div
                    variants={itemVariants}
                    whileHover={{ y: -8 }}
                    className="group relative overflow-hidden rounded-2xl border border-white/[0.08] bg-gradient-to-br from-white/[0.05] to-white/[0.02] p-8 backdrop-blur-xl transition-all duration-500 hover:border-cyan-400/20"
                  >
                  {/* Quote mark accent */}
      ...
      {/* ── CTA ────────────────────────────────────────────────── */}
      <AnimatedSection id="contact" className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
          <ParallaxSection speed={-0.5} scale={true}>
            ...
            >
              ...
              <h2 className="text-5xl font-bold text-white md:text-6xl lg:text-7xl leading-tight">
                Ready to create{" "}
